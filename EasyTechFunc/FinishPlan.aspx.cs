...
{
    public partial class FinishPlan : BaseWWW
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                com.ExecuteNonQuery();
                c = string.Format("insert into [dbtest].[dbo].[dfg_tq_stage](stage,finish_time,[index],rq_id) values('{0}',GETDATE(),4,{1})", "免费咨询",ConcernID);
                com = new SqlCommand(c, m_Connection);
                com.ExecuteNonQuery();
