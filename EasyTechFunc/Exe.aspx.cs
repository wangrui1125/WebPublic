...
{
    public partial class Exe : BaseWWW
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt16(MyReader[1].ToString()) != 6)
            {
                news = "该需求没有完成方案，不能分配执行！";
            ...
            else
            {
                ...
                Url = "WeChatTest.aspx?n=edittechManager&type=exe&id=" + ConcernID;
