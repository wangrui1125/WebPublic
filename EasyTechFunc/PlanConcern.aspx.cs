...
{
    public partial class PlanConcern : BaseWWW
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Admin == 1)
            {
                Url = "../Tmp/MyQuery.aspx?n=myplan7&ID=" + CurrentUser.Id;
            }
            else if (Researcher == 1)
            {
                Url = "../Tmp/MyQuery.aspx?n=myplan5&ID=" + CurrentUser.Id;
            }
            else if (Enterprise == 1)
            {
                Url = "../Tmp/MyQuery.aspx?n=myplan3&ID=" + CurrentUser.Id;
            }
          
            else if (techConsult == 1)
            {
                Url = "../Tmp/MyQuery.aspx?n=myplan2&ID=" + CurrentUser.Id;
            }
            else if (Manager == 1)
            {
                Url = "../Tmp/MyQuery.aspx?n=myplan6&ID=" + CurrentUser.Id;
            }
            else if (Consult == 1)
            {
                Url = "../Tmp/MyQuery.aspx?n=myplan4&ID=" + CurrentUser.Id;
            }
            else
            {
                return;
