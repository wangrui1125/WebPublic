...
{
    public partial class AddTechConsult : BaseWWW
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (m_Connection.State == System.Data.ConnectionState.Open)
            {
                ...
                m_Connection.Open();
            c = string.Format("Update [dbtest].[dbo].[TechRequire] set Rq_techConsultID='{0}' ,Rq_Owner='{0}',Rq_flag=5 where Rq_ID='{1}' ", ConcernID, Rq_ID);
