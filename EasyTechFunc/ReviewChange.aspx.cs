...
{
    public partial class ReviewChange : BaseWWW
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
             ...
             //   Label1.Visible = false;
                Url = "../Tmp/MyEdit.aspx?n=editReviewChange&ID=" + ConcernID ;
              //  Response.Write("<script language='javascript'>window.open('"+Url+"');</script>");
              //   Response.Write("<script>window.showModalDialog('"+Url+"')</script>");
